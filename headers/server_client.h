...
@return exit code 0 on success, negative otherwise
*/
...
*/
int set_socket_addr(const char *ip, const int port, struct sockaddr_in *server_addr);
...
@return socket socket file descriptor, negative value on error
*/
int create_listen_socket(struct sockaddr_in *server_addr, int reuseaddr, int sock_backlog);
...
@return socket socket file descriptor, negative value on error
*/
int create_broadcast_socket(struct sockaddr_in *server_addr, int reuseaddr, int broadcast, int backlog);
...
@return exit code -1 on error, 0 otherwise
*/
